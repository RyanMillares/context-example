 ...
 useEffect(() => {
  ...
  return (
    <div>
      ...
      <main>
        <div className="top">
        <h1>Hey there, {user.name}. You have some spare cash just burning a hole in your pocket? Come buy some overpriced potted plants!</h1>
        <Link href="/cart" >
          <div style = {{marginLeft: '10vw', cursor: 'pointer'}} class="cart">
            <h3>Cart</h3>
